 ...
 * @generated
 */
package com.lwh.netty.chp4.thrift.generated;
...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2018-09-11")
public class PersonService {
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public Person recv_getPersonByUsername() throws DataException, org.apache.thrift.TException {
            ...
            if (result.dataExcpetion != null) {
                throw result.dataExcpetion;
            }
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
        ...
        public static class getPersonByUsername<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUsername_args> {
            ...
            public getPersonByUsername_result getResult(I iface, getPersonByUsername_args args) throws org.apache.thrift.TException {
                ...
                } catch (DataException dataExcpetion) {
                    result.dataExcpetion = dataExcpetion;
                }
                return result;
            }
        }
                ...
                return new AsyncMethodCallback<Person>() {
                    ...
                    public void onError(Exception e) {
                        ...
                        if (e instanceof DataException) {
                            result.dataExcpetion = (DataException) e;
                            result.setDataExcpetionIsSet(true);
                            msg = result;
                        } else {
    ...
    public static class getPersonByUsername_result implements org.apache.thrift.TBase<getPersonByUsername_result, getPersonByUsername_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_result> {
        ...
        private static final org.apache.thrift.protocol.TField DATA_EXCPETION_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExcpetion", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
        ...
        public DataException dataExcpetion; // required

        /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
        public enum _Fields implements org.apache.thrift.TFieldIdEnum {
            SUCCESS((short) 0, "success"),
            DATA_EXCPETION((short) 1, "dataExcpetion");
            ...
            public static _Fields findByThriftId(int fieldId) {
                switch (fieldId) {
                    case 0: // SUCCESS
                        return SUCCESS;
                    case 1: // DATA_EXCPETION
                        return DATA_EXCPETION;
                    default:
                        return null;
                }
            }
        ...
        static {
            ...
            tmpMap.put(_Fields.DATA_EXCPETION, new org.apache.thrift.meta_data.FieldMetaData("dataExcpetion", org.apache.thrift.TFieldRequirementType.DEFAULT,
        ...
        public getPersonByUsername_result(
                Person success,
                DataException dataExcpetion) {
            this();
            this.success = success;
            this.dataExcpetion = dataExcpetion;
        }
        ...
        public getPersonByUsername_result(getPersonByUsername_result other) {
            ...
            if (other.isSetDataExcpetion()) {
                this.dataExcpetion = new DataException(other.dataExcpetion);
            }
        }
        ...
        public DataException getDataExcpetion() {
            return this.dataExcpetion;
        }

        public getPersonByUsername_result setDataExcpetion(DataException dataExcpetion) {
            this.dataExcpetion = dataExcpetion;
            return this;
        }

        public void unsetDataExcpetion() {
            this.dataExcpetion = null;
        }

        /** Returns true if field dataExcpetion is set (has been assigned a value) and false otherwise */
        public boolean isSetDataExcpetion() {
            return this.dataExcpetion != null;
        }

        public void setDataExcpetionIsSet(boolean value) {
            if (!value) {
                this.dataExcpetion = null;
            }
        }
            ...
            switch (field) {
                ...
                case DATA_EXCPETION:
                    if (value == null) {
                        ...
                        setDataExcpetion((DataException) value);
                    }
                    break;
        ...
        public boolean equals(getPersonByUsername_result that) {
            ...
            boolean this_present_dataExcpetion = true && this.isSetDataExcpetion();
            boolean that_present_dataExcpetion = true && that.isSetDataExcpetion();
            if (this_present_dataExcpetion || that_present_dataExcpetion) {
                if (!(this_present_dataExcpetion && that_present_dataExcpetion))
                    return false;
                if (!this.dataExcpetion.equals(that.dataExcpetion))
                    return false;
            }
        ...
        public int hashCode() {
            ...
            boolean present_dataExcpetion = true && (isSetDataExcpetion());
            list.add(present_dataExcpetion);
            if (present_dataExcpetion)
                list.add(dataExcpetion);
        ...
        public int compareTo(getPersonByUsername_result other) {
            ...
            lastComparison = Boolean.valueOf(isSetDataExcpetion()).compareTo(other.isSetDataExcpetion());
            if (lastComparison != 0) {
                return lastComparison;
            }
            if (isSetDataExcpetion()) {
                lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExcpetion, other.dataExcpetion);
                if (lastComparison != 0) {
                    return lastComparison;
                }
            }
        ...
        public String toString() {
            ...
            first = false;
            if (!first) sb.append(", ");
            sb.append("dataExcpetion:");
            if (this.dataExcpetion == null) {
                sb.append("null");
            } else {
                sb.append(this.dataExcpetion);
            }
            first = false;
            sb.append(")");
            return sb.toString();
        ...
        private static class getPersonByUsername_resultStandardScheme extends StandardScheme<getPersonByUsername_result> {
            ...
            public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
                ...
                while (true) {
                    ...
                    switch (schemeField.id) {
                        ...
                        case 1: // DATA_EXCPETION
                            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                                struct.dataExcpetion = new DataException();
                                struct.dataExcpetion.read(iprot);
                                struct.setDataExcpetionIsSet(true);
                            } else {
                                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
                            }
                            break;
            ...
            public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
                ...
                if (struct.dataExcpetion != null) {
                    oprot.writeFieldBegin(DATA_EXCPETION_FIELD_DESC);
                    struct.dataExcpetion.write(oprot);
                    oprot.writeFieldEnd();
                }
                oprot.writeFieldStop();
                oprot.writeStructEnd();
